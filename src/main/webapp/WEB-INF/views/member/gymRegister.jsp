...
<div class="form-container">
	<form name="opJoin" id="form" class="form" method="post"
		...
		<div class="column">
			<div class="input-box">
				<label>업체명</label><input type="text" name="operatorId"
					autocomplete="off" id="operatorId" tabindex="1"
					placeholder="업체명을 입력해주세요." required /><br> <span id="check"></span>
			</div>
		</div>

		<div class="column">
    <div class="input-box">
        <label for="operatorCategory">업체구분</label>
        <select name="operatorCategory" id="operatorCategory" required>
		...
		<div class="column">
			<div class="input-box">
				<label>업체주소</label> <input type="text" id="sample6_postcode"
		...
		<div class="column">
			<div class="input-box">
				<label>업체 전화번호</label> <input type="text" placeholder="전화번호를 입력해 주세요."
		...
		<div class="column">
			<div class="input-box">
				<label for="inputGroupFile04">업체사진등록</label>
