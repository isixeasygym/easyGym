<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <div class="footer">
          <ul class="nav justify-content-center border-bottom pb-3 mb-3 ">
                    ...
                    <li class="nav-item"><a href="/detail/showAll.do?detailClassification=health" class="nav-link px-2 text-body-secondary">Pricing</a></li>
                    <li class="nav-item"><a href="/freeboard/fboardList.do" class="nav-link px-2 text-body-secondary">FAQs</a></li>
