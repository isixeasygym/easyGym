...
<link rel="stylesheet" type="text/css" href="/resources/bootstrap-5.3.3-dist/css/bootstrap.min.css">
...
.welcome-message {
  ...
  .navbar-nav .nav-item {
    padding-left: 5px; /* 왼쪽 패딩을 5px로 설정 */
    padding-right: 5px; /* 오른쪽 패딩을 5px로 설정 */
  }
</style>
</head>
<body>
	<nav class="navbar navbar-expand-md navbar-dark bg-dark">
		...
		<ul class="navbar-nav me-auto mb-2 mb-lg-0">
			...
			<li class="nav-item"><a class="nav-link" href="${contextPath}/freeboard/fboardList.do">커뮤니티</a></li>
